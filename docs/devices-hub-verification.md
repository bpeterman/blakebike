...
- [ ] **D4 · Trainer drop mid-ride.** Power-cycle the trainer during a free ride. Expected: ride keeps running on the other sensors, trainer card shows Link lost, and after reconnecting the ERG target is re-applied on the next step change.
